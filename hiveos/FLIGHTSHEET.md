...
```
https://github.com/BlacksmithMiner/blacksmith/releases/download/v1.1/blacksmith-hiveos-1.1.tar.gz
```

**Option B — manual.** Download `blacksmith-hiveos-1.1.tar.gz` from the
[Releases](https://github.com/BlacksmithMiner/blacksmith/releases) page and, on the rig:

```bash
cd /hive/miners/custom && tar xzf blacksmith-hiveos-1.1.tar.gz
```
...
|--------------------------------|------------------------------------------------------------------------------|
| **Installation URL**           | `https://github.com/BlacksmithMiner/blacksmith/releases/download/v1.1/blacksmith-hiveos-1.1.tar.gz` |
